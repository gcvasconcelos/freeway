...
int main() {
    int i = 1, j, enter = 0, contador, cont1 = 0, cont2 = 0, q = 0;
    ...
    caminhao_grupo_8, carro_grupo_9, caminhao_grupo_9, enter_grupo, ghost, galinha0; //grupos
    ...
    int vpower[10] = {-79, -62.5, -46, -30.1, -14, 66, 49.5, 33.5, 17.5, 2};
    int tempo_pow = 0, k = 1, l = 1, power_grupo, rand_power;
    ...
    canto.x=-145; canto.y=-100; //jogo
    CriaRetangulo(300, 200, canto);
    Pintar(255, 255, 255);
    AssociaImagem(fundo);

    pvida1.x = -60;pvida1.y = 90;//#
    ...
    while(i){
        ...
        if (nvidas1 == 0 || cont2 == 3){ //#
            ...
            nvidas2--;
            cont1++;
            pwin.x = -90;pwin.y = -20; //mostra qual jogador venceu
            CriaRetangulo(180, 40, pwin);
            Pintar(255, 255, 255);
            AssociaImagem(win1);
        ...
        /*tempo_pow++;
        if (tempo_pow == 300*k){
            power_grupo = CriaGrupo();
            ppower1.x = -60;
            ppower1.y = vpower[rand()%10];
            CriaQuadrado(10, ppower1);
            Pintar(255, 255, 255);
            AssociaImagem(power_up);
            k++;
        }
        if (tempo_pow == 600*l){
            ApagaGrupo(power_grupo);
            l++;
        }*/

        //O grande detector de colisoes

        if  ((pow(pista_0.x-galcentro1.x,2)+pow(pista_0.y-galcentro1.y,2)<=pow(4,2)||
            pow(pista_0.x-galcentro1.x+13,2)+pow(pista_0.y-galcentro1.y+8,2)<=pow(4,2)||
            pow(pista_0.x-galcentro1.x,2)+pow(pista_0.y-galcentro1.y+8,2)<=pow(4,2)||
            pow(pista_0.x-galcentro1.x+13,2)+pow(pista_0.y-galcentro1.y,2)<=pow(4,2)) ||
            (pow(pista_1.x-galcentro1.x,2)+pow(pista_1.y-galcentro1.y,2)<=pow(4,2)||
            pow(pista_1.x-galcentro1.x+13,2)+pow(pista_1.y-galcentro1.y+8,2)<=pow(4,2)||
            pow(pista_1.x-galcentro1.x,2)+pow(pista_1.y-galcentro1.y+8,2)<=pow(4,2)||
            pow(pista_1.x-galcentro1.x+13,2)+pow(pista_1.y-galcentro1.y,2)<=pow(4,2)) ||
            (pow(pista_2.x-galcentro1.x,2)+pow(pista_2.y-galcentro1.y,2)<=pow(4,2)||
            pow(pista_2.x-galcentro1.x+13,2)+pow(pista_2.y-galcentro1.y+8,2)<=pow(4,2)||
            pow(pista_2.x-galcentro1.x,2)+pow(pista_2.y-galcentro1.y+8,2)<=pow(4,2)||
            pow(pista_2.x-galcentro1.x+13,2)+pow(pista_2.y-galcentro1.y,2)<=pow(4,2)) ||
            (pow(pista_3.x-galcentro1.x,2)+pow(pista_3.y-galcentro1.y,2)<=pow(4,2)||
            pow(pista_3.x-galcentro1.x+13,2)+pow(pista_3.y-galcentro1.y+8,2)<=pow(4,2)||
            pow(pista_3.x-galcentro1.x,2)+pow(pista_3.y-galcentro1.y+8,2)<=pow(4,2)||
            pow(pista_3.x-galcentro1.x+13,2)+pow(pista_3.y-galcentro1.y,2)<=pow(4,2)) ||
            (pow(pista_4.x-galcentro1.x,2)+pow(pista_4.y-galcentro1.y,2)<=pow(4,2)||
            pow(pista_4.x-galcentro1.x+13,2)+pow(pista_4.y-galcentro1.y+8,2)<=pow(4,2)||
            pow(pista_4.x-galcentro1.x,2)+pow(pista_4.y-galcentro1.y+8,2)<=pow(4,2)||
            pow(pista_4.x-galcentro1.x+13,2)+pow(pista_4.y-galcentro1.y,2)<=pow(4,2)) ||
            (pow(pista_5.x-galcentro1.x,2)+pow(pista_5.y-galcentro1.y,2)<=pow(4,2)||
            pow(pista_5.x-galcentro1.x+13,2)+pow(pista_5.y-galcentro1.y+8,2)<=pow(4,2)||
            pow(pista_5.x-galcentro1.x,2)+pow(pista_5.y-galcentro1.y+8,2)<=pow(4,2)||
            pow(pista_5.x-galcentro1.x+13,2)+pow(pista_5.y-galcentro1.y,2)<=pow(4,2)) ||
            (pow(pista_6.x-galcentro1.x,2)+pow(pista_6.y-galcentro1.y,2)<=pow(4,2)||
            pow(pista_6.x-galcentro1.x+13,2)+pow(pista_6.y-galcentro1.y+8,2)<=pow(4,2)||
            pow(pista_6.x-galcentro1.x,2)+pow(pista_6.y-galcentro1.y+8,2)<=pow(4,2)||
            pow(pista_6.x-galcentro1.x+13,2)+pow(pista_6.y-galcentro1.y,2)<=pow(4,2)) ||
            (pow(pista_7.x-galcentro1.x,2)+pow(pista_7.y-galcentro1.y,2)<=pow(4,2)||
            pow(pista_7.x-galcentro1.x+13,2)+pow(pista_7.y-galcentro1.y+8,2)<=pow(4,2)||
            pow(pista_7.x-galcentro1.x,2)+pow(pista_7.y-galcentro1.y+8,2)<=pow(4,2)||
            pow(pista_7.x-galcentro1.x+13,2)+pow(pista_7.y-galcentro1.y,2)<=pow(4,2)) ||
            (pow(pista_8.x-galcentro1.x,2)+pow(pista_8.y-galcentro1.y,2)<=pow(4,2)||
            pow(pista_8.x-galcentro1.x+13,2)+pow(pista_8.y-galcentro1.y+8,2)<=pow(4,2)||
            pow(pista_8.x-galcentro1.x,2)+pow(pista_8.y-galcentro1.y+8,2)<=pow(4,2)||
            pow(pista_8.x-galcentro1.x+13,2)+pow(pista_8.y-galcentro1.y,2)<=pow(4,2)) ||
            (pow(pista_9.x-galcentro1.x,2)+pow(pista_9.y-galcentro1.y,2)<=pow(4,2)||
            pow(pista_9.x-galcentro1.x+13,2)+pow(pista_9.y-galcentro1.y+8,2)<=pow(4,2)||
            pow(pista_9.x-galcentro1.x,2)+pow(pista_9.y-galcentro1.y+8,2)<=pow(4,2)||
            pow(pista_9.x-galcentro1.x+13,2)+pow(pista_9.y-galcentro1.y,2)<=pow(4,2)))
        {
            nvidas1--; //#
        ...
        if ((pow(pista_0.x-galcentro2.x,2)+pow(pista_0.y-galcentro2.y,2)<=pow(4,2)||
            pow(pista_0.x-galcentro2.x+13,2)+pow(pista_0.y-galcentro2.y+8,2)<=pow(4,2)||
            pow(pista_0.x-galcentro2.x,2)+pow(pista_0.y-galcentro2.y+8,2)<=pow(4,2)||
            pow(pista_0.x-galcentro2.x+13,2)+pow(pista_0.y-galcentro2.y,2)<=pow(4,2)) ||
            (pow(pista_1.x-galcentro2.x,2)+pow(pista_1.y-galcentro2.y,2)<=pow(4,2)||
            pow(pista_1.x-galcentro2.x+13,2)+pow(pista_1.y-galcentro2.y+8,2)<=pow(4,2)||
            pow(pista_1.x-galcentro2.x,2)+pow(pista_1.y-galcentro2.y+8,2)<=pow(4,2)||
            pow(pista_1.x-galcentro2.x+13,2)+pow(pista_1.y-galcentro2.y,2)<=pow(4,2)) ||
            (pow(pista_2.x-galcentro2.x,2)+pow(pista_2.y-galcentro2.y,2)<=pow(4,2)||
            pow(pista_2.x-galcentro2.x+13,2)+pow(pista_2.y-galcentro2.y+8,2)<=pow(4,2)||
            pow(pista_2.x-galcentro2.x,2)+pow(pista_2.y-galcentro2.y+8,2)<=pow(4,2)||
            pow(pista_2.x-galcentro2.x+13,2)+pow(pista_2.y-galcentro2.y,2)<=pow(4,2)) ||
            (pow(pista_3.x-galcentro2.x,2)+pow(pista_3.y-galcentro2.y,2)<=pow(4,2)||
            pow(pista_3.x-galcentro2.x+13,2)+pow(pista_3.y-galcentro2.y+8,2)<=pow(4,2)||
            pow(pista_3.x-galcentro2.x,2)+pow(pista_3.y-galcentro2.y+8,2)<=pow(4,2)||
            pow(pista_3.x-galcentro2.x+13,2)+pow(pista_3.y-galcentro2.y,2)<=pow(4,2)) ||
            (pow(pista_4.x-galcentro2.x,2)+pow(pista_4.y-galcentro2.y,2)<=pow(4,2)||
            pow(pista_4.x-galcentro2.x+13,2)+pow(pista_4.y-galcentro2.y+8,2)<=pow(4,2)||
            pow(pista_4.x-galcentro2.x,2)+pow(pista_4.y-galcentro2.y+8,2)<=pow(4,2)||
            pow(pista_4.x-galcentro2.x+13,2)+pow(pista_4.y-galcentro2.y,2)<=pow(4,2)) ||
            (pow(pista_5.x-galcentro2.x,2)+pow(pista_5.y-galcentro2.y,2)<=pow(4,2)||
            pow(pista_5.x-galcentro2.x+13,2)+pow(pista_5.y-galcentro2.y+8,2)<=pow(4,2)||
            pow(pista_5.x-galcentro2.x,2)+pow(pista_5.y-galcentro2.y+8,2)<=pow(4,2)||
            pow(pista_5.x-galcentro2.x+13,2)+pow(pista_5.y-galcentro2.y,2)<=pow(4,2)) ||
            (pow(pista_6.x-galcentro2.x,2)+pow(pista_6.y-galcentro2.y,2)<=pow(4,2)||
            pow(pista_6.x-galcentro2.x+13,2)+pow(pista_6.y-galcentro2.y+8,2)<=pow(4,2)||
            pow(pista_6.x-galcentro2.x,2)+pow(pista_6.y-galcentro2.y+8,2)<=pow(4,2)||
            pow(pista_6.x-galcentro2.x+13,2)+pow(pista_6.y-galcentro2.y,2)<=pow(4,2)) ||
            (pow(pista_7.x-galcentro2.x,2)+pow(pista_7.y-galcentro2.y,2)<=pow(4,2)||
            pow(pista_7.x-galcentro2.x+13,2)+pow(pista_7.y-galcentro2.y+8,2)<=pow(4,2)||
            pow(pista_7.x-galcentro2.x,2)+pow(pista_7.y-galcentro2.y+8,2)<=pow(4,2)||
            pow(pista_7.x-galcentro2.x+13,2)+pow(pista_7.y-galcentro2.y,2)<=pow(4,2)) ||
            (pow(pista_8.x-galcentro2.x,2)+pow(pista_8.y-galcentro2.y,2)<=pow(4,2)||
            pow(pista_8.x-galcentro2.x+13,2)+pow(pista_8.y-galcentro2.y+8,2)<=pow(4,2)||
            pow(pista_8.x-galcentro2.x,2)+pow(pista_8.y-galcentro2.y+8,2)<=pow(4,2)||
            pow(pista_8.x-galcentro2.x+13,2)+pow(pista_8.y-galcentro2.y,2)<=pow(4,2)) ||
            (pow(pista_9.x-galcentro2.x,2)+pow(pista_9.y-galcentro2.y,2)<=pow(4,2)||
            pow(pista_9.x-galcentro2.x+13,2)+pow(pista_9.y-galcentro2.y+8,2)<=pow(4,2)||
            pow(pista_9.x-galcentro2.x,2)+pow(pista_9.y-galcentro2.y+8,2)<=pow(4,2)||
            pow(pista_9.x-galcentro2.x+13,2)+pow(pista_9.y-galcentro2.y,2)<=pow(4,2)))
        {
            nvidas2--; //#
